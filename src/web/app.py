...
def get_default_middle_east_scenarios():
    ...
    return [
        ...
        },
        {
            ...
            'type': 'de-escalation',
            'probability': 0.2,
            'gold_price_range': '4400-4700',
            'silver_price_range': '68-72',
            'crude_price_range': '88-96',
        ...
        },
        {
            ...
            'type': 'escalation',
            'probability': 0.2,
            'gold_price_range': '4900-5200',
            'silver_price_range': '75-79',
            'crude_price_range': '100-108',
        ...
        },
        {
            ...
            'type': 'major-crisis',
            'probability': 0.05,
            'gold_price_range': '5200-5700',
            'silver_price_range': '79-85',
            'crude_price_range': '108-120',
            'suggested_action': 'buy',
            'action_text': '重仓做多',
            'trigger_signals': [
                '伊朗与美国/以色列爆发全面冲突',
